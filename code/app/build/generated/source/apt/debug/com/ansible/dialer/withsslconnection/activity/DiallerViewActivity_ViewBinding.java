...
package com.ansible.dialer.withsslconnection.activity;
...
import com.ansible.dialer.withsslconnection.R;
...
public class DiallerViewActivity_ViewBinding implements Unbinder {
  ...
  public DiallerViewActivity_ViewBinding(final DiallerViewActivity target, View source) {
    ...
    target.llEmergency = Utils.findRequiredViewAsType(source, R.id.ll_emergency, "field 'llEmergency'", LinearLayout.class);
    ...
    view = Utils.findRequiredView(source, R.id.iv_info, "field 'ivInfo' and method 'onViewClicked'");
    target.ivInfo = Utils.castView(view, R.id.iv_info, "field 'ivInfo'", ImageView.class);
    view2131296358 = view;
